class TestFunctionalListImpl {
    public static void main(String[] input){
        FunctionalArrayListImpl  testFunctionalList = new FunctionalArrayListImpl();
        ...
        ReturnObjectImpl headItem = testFunctionalList.head();
        FunctionalArrayListImpl newList = testFunctionalList.rest();
