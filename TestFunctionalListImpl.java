class TestFunctionalListImpl {
    ...
    private static void runTests(FunctionalList testFunctionalList){ 
        ...
        if(headItem.getError() != ErrorMessage.EMPTY_STRUCTURE && newList.size() != 0)
            System.out.println(headItem.getError() + "--" + newList.size());
        ...
        headItem = testFunctionalList.head();
        newList = testFunctionalList.rest();
